...
Scheduler,Cosine,Cosine,✓
Epochs,200,5,✗ — hardware constraint
...
Due to hardware constraints, the following deviations from the paper were necessary:

SimCLR backbone trained for 50 epochs instead of 500

Self-supervised (linear) evaluation run for 5 epochs instead of 200
